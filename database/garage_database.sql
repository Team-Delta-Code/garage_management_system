...
// <![CDATA[
CommonParams.setAll({common_query:"",opendb_url:"index.php?route=/database/structure",lang:"en",server:"1",table:"",db:"",token:"7d262e5d416c424d3a6c4f2e276f4636",text_dir:"ltr",LimitChars:"50",pftext:"P",confirm:true,LoginCookieValidity:"1440",session_gc_maxlifetime:"1440",logged_in:true,is_https:false,rootPath:"/phpmyadmin/",arg_separator:"&",version:"5.2.1",auth_type:"config",user:"root"});
...
<body>
  ...
  <a href="index.php?route=/table/recent-favorite&db=garage_database&table=appointments">
    `garage_database`.`appointments`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=garage_database&table=garage_services">
    `garage_database`.`garage_services`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=garage_database&table=vehicle_data">
    `garage_database`.`vehicle_data`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=garage_database&table=service_order">
    `garage_database`.`service_order`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=garage_database&table=customer_data">
    `garage_database`.`customer_data`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=garage_database&table=employee_attendance">
    `garage_database`.`employee_attendance`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=garage_database&table=transactions">
    `garage_database`.`transactions`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=garage_database&table=customer_support">
    `garage_database`.`customer_support`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=garage_database&table=employees">
    `garage_database`.`employees`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=garage_database&table=employee_roles">
    `garage_database`.`employee_roles`
  </a>
</li>
...
<div id='pma_navigation_tree_content'>
    ...
    <div class="block">
      <i></i>
        ...
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.Z2FyYWdlX2RhdGFiYXNl" data-vpath="cm9vdA==.Z2FyYWdlX2RhdGFiYXNl" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=garage_database"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=garage_database" title="Structure">garage_database</a>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="7d262e5d416c424d3a6c4f2e276f4636">
  ...
  <div id="pma_console_container" class="d-print-none">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="garage_database" targettable="appointments">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `appointments` ADD INDEX(`time_stamp`);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="garage_database" targettable="garage_services">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `garage_services`</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="garage_database" targettable="garage_services">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO appointments (cust_name, service_id, time_stamp) VALUES
(&#039;John Doe&#039;, &#039;serv001&#039;, &#039;2025-02-14 10:00:00&#039;),
(&#039;Sanath Nishantha&#039;, &#039;serv004&#039;, &#039;2025-02-21 13:30:00&#039;),
(&#039;Janith Lanarole&#039;, &#039;serv003&#039;, &#039;2025-02-18 09:45:00&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="garage_database" targettable="appointments">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO appointments (cust_name, service_id, time_stamp) VALUES
(&#039;Ben10 Bandara&#039;, &#039;serv003&#039;, &#039;2025-02-13 09:45:00&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="garage_database" targettable="appointments">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `appointments` DROP `time_stamp`;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="garage_database" targettable="appointments">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `appointments` ADD `time_stamp` DATETIME NOT NULL AFTER `service_id`;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="garage_database" targettable="appointments">
                            <div class="action_content">
