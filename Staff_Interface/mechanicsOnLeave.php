                ...
                <div class="main-header">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            $stmt0 = $connect->prepare("SELECT `employee_id`, `emp_first_name`, `emp_last_name` FROM employees a JOIN employee_attendance b ON a.`employee_id`=b.`emp_id` WHERE a.`role_id`='role_mech' AND DATE(time_stamp) = CURDATE() AND availability = 0;");
                            $stmt0->execute();
                            ...
                            if (empty($results)) {
                                ...
                                $firstName = "";
                                $lastName = "";
                                echo "<tr><td colspan='3' style='text-align: center;'>No mechanics are on leave</td></tr>";
                            } else {
